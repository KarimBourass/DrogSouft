...
public class UtilisateurService {
	...
	public Utilisateur findByResetToken(String resetToken){ return utilisateurRepository.findByResetToken(resetToken); }

	public List<Utilisateur> chercherUtilisateur(String nom){
		return utilisateurRepository.chercherUtilisateur("%"+nom+"%");
	}

	public void updateresetToken(String email,String resetToekn) {
		utilisateurRepository.updateresetToken(email,resetToekn);
	}

	public void updatePassword(String token, String password) {

		utilisateurRepository.updatePassword(token,password);
	}
}
